...
case $1 in
    ...
    "emoji") rofimoji --action clipboard --selector-args="-theme-str 'listview{lines:4;columns:6;fixed-columns:true;flow:horizontal;} element-text{font:\"system-ui 13\";} element{padding:11px;margin:3px;}'" \
